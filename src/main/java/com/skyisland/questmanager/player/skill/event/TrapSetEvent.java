...
public class TrapSetEvent extends Event implements Cancellable {
	...
	public TrapSetEvent(QuestPlayer player, QualityItem result, int difficulty) {
		this.player = player;
		this.result = result;
		this.difficulty = difficulty;
		this.isCancelled = false;
		
		this.timingModifier = this.amountModifier = this.qualityModifier = 1.0;
	}
